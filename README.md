...
| [`云端监控平台/`](云端监控平台/) | Web 发布快照、Qt 上位机及云端界面设计资料 |
...
4. 云端监控平台：查看 `云端监控平台/README.md`，了解 Web 发布快照与 Qt
   上位机的使用范围。
5. 各模块的依赖、参数和验证方法见对应目录 README。
...
| [`云端监控平台/`](云端监控平台/) | Web release snapshot, Qt host application, and cloud UI design assets |
...
4. Cloud platform: read `云端监控平台/README.md` for the scope of the Web
   release snapshot and Qt host application.
5. See each module README for dependencies, parameters, and validation steps.
